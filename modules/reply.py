...
faq = {
    ...
    '蘋果': TextSendMessage(
        text="蘋果 2023/5/15 買點:173，賣點182"
    ),
    '谷歌': TextSendMessage(
        text="谷歌 2023/5/15 買點:101，賣點110"
    ),
    '微軟': TextSendMessage(
        text="微軟 2023/5/15 買點:290，賣點307"
    ),
    '臉書': TextSendMessage(
        text="臉書 2023/5/15 買點:130，賣點150"
    ),
    '輝達': TextSendMessage(
        text="輝達 2023/5/15 買點:277，賣點297"
    ),
    '超微': TextSendMessage(
        text="超微 2023/5/15 買點:90，賣點102"
    ),
    '特斯拉': TextSendMessage(
        text="特斯拉 2023/5/15 買點:160，賣點180"
    ),
    '亞馬遜': TextSendMessage(
        text="亞馬遜 2023/5/15 買點:97，賣點109"
    ),
    'TSMC': TextSendMessage(
        text="台積電 2023/5/15 買點:458，賣點469"
    ),
    'Foxconn': TextSendMessage(
        text="鴻海 2023/5/15 買點:98，賣點99"
    ),
    'MediaTek': TextSendMessage(
        text="聯發科 2023/5/15 買點:663，賣點672"
    ),
