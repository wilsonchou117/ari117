...
faq = {
    ...
    '蘋果': TextSendMessage(
        text="蘋果 2024/1/18 買點:172，賣點181"
    ),
    '谷歌': TextSendMessage(
        text="谷歌 2024/1/18 買點:137，賣點142"
    ),
    '微軟': TextSendMessage(
        text="微軟 2024/1/18 買點:376，賣點389"
    ),
    '臉書': TextSendMessage(
        text="臉書 2024/1/18 買點:356，賣點369"
    ),
    '輝達': TextSendMessage(
        text="輝達 2024/1/18 買點:517，賣點576"
    ),
    '超微': TextSendMessage(
        text="超微 2024/1/18 買點:151，賣點165"
    ),
    '特斯拉': TextSendMessage(
        text="特斯拉 2024/1/18 買點:201，賣點225"
    ),
    '亞馬遜': TextSendMessage(
        text="亞馬遜 2024/1/18 買點:149，賣點152"
    ),
    'TSMC': TextSendMessage(
        text="台積電 2024/1/18 買點:591，賣點624"
    ),
    'Foxconn': TextSendMessage(
        text="鴻海 2024/1/18 買點:95.8，賣點99.8"
    ),
    'MediaTek': TextSendMessage(
        text="聯發科 2023/1/18 買點:995，賣點1190"
    ),
