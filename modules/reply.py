...
faq = {
    ...
    '蘋果': TextSendMessage(
        text="蘋果 2024/1/19 買點:不追高，賣點181"
    ),
    '谷歌': TextSendMessage(
        text="谷歌 2024/1/19 買點:不追高，賣點142"
    ),
    '微軟': TextSendMessage(
        text="微軟 2024/1/19 買點:不追高，賣點389"
    ),
    '臉書': TextSendMessage(
        text="臉書 2024/1/19 買點:不追高，賣點369"
    ),
    '輝達': TextSendMessage(
        text="輝達 2024/1/19 買點:不追高，賣點576"
    ),
    '超微': TextSendMessage(
        text="超微 2024/1/19 買點:不追高，賣點165"
    ),
    '特斯拉': TextSendMessage(
        text="特斯拉 2024/1/19 買點:不追高，賣點225"
    ),
    '亞馬遜': TextSendMessage(
        text="亞馬遜 2024/1/19 買點:不追高，賣點152"
    ),
