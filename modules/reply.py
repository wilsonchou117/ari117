...
faq = {
    ...
    '蘋果': TextSendMessage(
        text="蘋果 2023/8/3 買點:182，賣點192"
    ),
    '谷歌': TextSendMessage(
        text="谷歌 2023/8/3 買點:99，賣點120"
    ),
    '微軟': TextSendMessage(
        text="微軟 2023/8/3 買點:285，賣點307"
    ),
    '臉書': TextSendMessage(
        text="臉書 2023/8/3 買點:130，賣點150"
    ),
    '輝達': TextSendMessage(
        text="輝達 2023/8/3 買點:400，賣點440"
    ),
    '超微': TextSendMessage(
        text="超微 2023/8/3 買點:97.5，賣點103"
    ),
    '特斯拉': TextSendMessage(
        text="特斯拉 2023/8/3 買點:230，賣點241"
    ),
    '亞馬遜': TextSendMessage(
        text="亞馬遜 2023/8/3 買點:97，賣點109"
    ),
    'TSMC': TextSendMessage(
        text="台積電 2023/8/4 買點:548，賣點552"
    ),
    'Foxconn': TextSendMessage(
        text="鴻海 2023/8/4 買點:107，賣點108"
    ),
    'MediaTek': TextSendMessage(
        text="聯發科 2023/8/4 買點:695，賣點702"
    ),
