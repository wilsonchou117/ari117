...
faq = {
    ...
    '蘋果': TextSendMessage(
        text="蘋果 2023/9/11 買點:172，賣點190"
    ),
    '谷歌': TextSendMessage(
        text="谷歌 2023/9/11 買點:132，賣點138"
    ),
    '微軟': TextSendMessage(
        text="微軟 2023/9/11 買點:317，賣點340"
    ),
    '臉書': TextSendMessage(
        text="臉書 2023/9/11 買點:280，賣點292"
    ),
    '輝達': TextSendMessage(
        text="輝達 2023/9/11 買點:430，賣點493"
    ),
    '超微': TextSendMessage(
        text="超微 2023/9/11 買點:88，賣點96"
    ),
    '特斯拉': TextSendMessage(
        text="特斯拉 2023/9/11 買點:220，賣點282"
    ),
    '亞馬遜': TextSendMessage(
        text="亞馬遜 2023/9/11 買點:130，賣點141"
    ),
    'TSMC': TextSendMessage(
        text="台積電 2023/9/11 買點:548，賣點552"
    ),
    'Foxconn': TextSendMessage(
        text="鴻海 2023/9/11 買點:107，賣點108"
    ),
    'MediaTek': TextSendMessage(
        text="聯發科 2023/9/11 買點:695，賣點702"
    ),
