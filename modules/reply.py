...
faq = {
    ...
    '蘋果': TextSendMessage(
        text="蘋果 2024/2/1 買點:180.5，賣點199"
    ),
    '谷歌': TextSendMessage(
        text="谷歌 2024/2/1 買點:138.5，賣點144"
    ),
    '微軟': TextSendMessage(
        text="微軟 2024/2/1 買點:395，賣點414"
    ),
    '臉書': TextSendMessage(
        text="臉書 2024/2/1 買點:379，賣點405"
    ),
    '輝達': TextSendMessage(
        text="輝達 2024/2/1 買點:596，賣點634"
    ),
    '超微': TextSendMessage(
        text="超微 2024/2/1 買點:159，賣點185"
    ),
    '特斯拉': TextSendMessage(
        text="特斯拉 2024/2/1 買點:180，賣點214"
    ),
    '亞馬遜': TextSendMessage(
        text="亞馬遜 2024/2/1 買點:153，賣點214"
    ),
    'TSMC': TextSendMessage(
        text="台積電 2024/2/2 買點:不追高，賣點624"
    ),
    'Foxconn': TextSendMessage(
        text="鴻海 2024/2/2 買點:不追高，賣點99.8"
    ),
    'MediaTek': TextSendMessage(
        text="聯發科 2023/2/2 買點:不追高，賣點1190"
    ),
