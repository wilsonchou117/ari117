...
faq = {
    ...
    '蘋果': TextSendMessage(
        text="蘋果 2024/2/20 買點:180.5，賣點202"
    ),
    '谷歌': TextSendMessage(
        text="谷歌 2024/2/20 買點:140，賣點153"
    ),
    '微軟': TextSendMessage(
        text="微軟 2024/2/20 買點:395，賣點419"
    ),
    '臉書': TextSendMessage(
        text="臉書 2024/2/20 買點:445，賣點488"
    ),
    '輝達': TextSendMessage(
        text="輝達 2024/2/20 買點:716，賣點749"
    ),
    '超微': TextSendMessage(
        text="超微 2024/2/20 買點:165，賣點185"
    ),
    '特斯拉': TextSendMessage(
        text="特斯拉 2024/2/20 買點:199，賣點221"
    ),
    '亞馬遜': TextSendMessage(
        text="亞馬遜 2024/2/20 買點:164，賣點172"
    ),
    'TSMC': TextSendMessage(
        text="台積電 2024/2/20 買點:667，賣點699"
    ),
    'Foxconn': TextSendMessage(
        text="鴻海 2024/2/20 買點:101，賣點103"
    ),
    'MediaTek': TextSendMessage(
        text="聯發科 2023/2/20 買點:945，賣點996"
    ),
